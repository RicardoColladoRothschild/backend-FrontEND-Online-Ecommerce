...
var UsersServices = /** @class */ (function () {
    function UsersServices(user) {
        this._user = user;
    }
    UsersServices.prototype.createAUser = function () {
        return __awaiter(this, void 0, void 0, function () {
            var isEmailDuplicated, isUserNameDuplicated;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Users_model_1.default.findOne({
                            where: { email: this._user.email }
                        })];
                    case 1:
                        isEmailDuplicated = _a.sent();
                        return [4 /*yield*/, Users_model_1.default.findOne({
                                where: { username: this._user.username }
                            })];
                    case 2:
                        isUserNameDuplicated = _a.sent();
                        return [2 /*return*/, new Promise(function (resolve, reject) {
                                if (isEmailDuplicated || isUserNameDuplicated) {
                                    reject('user was not created. Already exist.');
                                }
                                else {
                                    var newUser = Users_model_1.default.create({
                                        username: _this._user.username,
                                        email: _this._user.email,
                                        password: _this._user.password,
                                        name: _this._user.name,
                                        lastName: _this._user.lastName,
                                        direccion: _this._user.direccion
                                    });
                                    resolve(newUser);
                                }
                            })];
